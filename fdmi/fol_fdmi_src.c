 ...
 * FDMI plugin. BE tx reference taken means ih this case that BE tx wouldn't be
 ...
 * resent as FDMI FOL records then it will be no FDMI FOL record missing on FDMI
 * plugin side regardless of if FDMI source restarts or not and how and how many
 * times it restarts.
 *
